<?php include ROOT.'/views/inc/header.php'; ?>
    ...
    <div class="container">
        <button type="button" class="btn btn-warning mt-3 text-gray-900" data-bs-toggle="modal" data-bs-target="#exampleModalMd">Новая задача</button>
                ...
                <div class="bg-secondary rounded-3">
                    ...
                    <div class="pb-4">
                        ...
                        <div class="list-group sortable" data-shared-group="client-list">
                            ...
                            <button type="button" class="btn p-0" data-bs-toggle="modal" data-bs-target="#exampleModaltask">
                            <div class="row mx-3 bg-white text-dark rounded-3 mb-2">
                                <div class="col-10 py-2">
                                    Понять как это работает 1
                                </div>
...
<!-- modal task -->
    <div class="modal fade" id="exampleModaltask" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabeltask" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="js-ajax bs-validate" novalidate
                        ...
                        <div class="mb-3">
                            <label for="formFileMultiple" class="form-label">Загрузить файлы</label>
                            <input class="form-control rad-10" type="file" id="formFileMultiple" multiple>
                        </div>
                    </form>
                </div>
